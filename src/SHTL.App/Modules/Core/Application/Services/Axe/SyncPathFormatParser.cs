...
public static class SyncPathFormatParser
{
    ...
    public static void ApplyFolderSegmentsToFields(SHTL.Modules.Core.Domain.Entities.Stg.Document doc, string? relativePath, int maxDepth = 15)
    {
    ...
    private static void SetFieldBySlot(SHTL.Modules.Core.Domain.Entities.Stg.Document doc, int index, string value)
    {
        switch (index)
        {
