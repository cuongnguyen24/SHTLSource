...
public interface IDocumentSearchService
{
    ...
    Task<IEnumerable<DocumentSearchDocument>> SearchAsync(string query, int from = 0, int size = 20);
...
public class DocumentSearchService : IDocumentSearchService
{
    ...
    public async Task<IEnumerable<DocumentSearchDocument>> SearchAsync(string query, int from = 0, int size = 20)
    {
