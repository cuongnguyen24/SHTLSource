...
// Đường dẫn tương đối theo URL của viewer.html (hỗ trợ PathBase /sohoa/...)
...
function webViewerInitialized() {
  ...
  var file = 'file' in params ? params.file : (jQuery("#DEFAULT_URL").val() + "?rand=" + (new Date()).getTime());
...
function updateViewarea() {
  if (!PDFViewerApplication.initialized) {
    ...
    try { OCR.HienKhoanhVung(); } catch (e) { }
}
...
function rotate_Page_pdf(deg,type_rotate, rotate_page_number) {
    ...
    target.each(function(){
        ...
        var change_px = (page_height_float - page_width_float)/2;
        ...
        $(this).find(".canvasWrapper").css({'-webkit-transform' : 'rotate('+ curent_rotate +'deg)',
        ...
        $(this).find(".textLayer").css({'-webkit-transform' : 'rotate('+ curent_rotate +'deg)',
               '-moz-transform' : 'rotate('+ curent_rotate +'deg)',
               '-ms-transform' : 'rotate('+ curent_rotate +'deg)',
               'transform' : 'rotate('+ curent_rotate +'deg)'}); 
