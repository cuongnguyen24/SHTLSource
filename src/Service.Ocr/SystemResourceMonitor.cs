...
internal static class SystemResourceMonitor
{
    ...
    /// Logic scale:
    /// <list type="bullet">
    ///   <item>Nếu <see cref="OcrSearchablePdfWorkerOptions.MaxConcurrentWorkers"/> &gt; 0 → dùng cố định, bỏ qua auto-scale.</item>
    ...
    /// </para>
    /// </summary>
    public static int ComputeTargetWorkers(OcrSearchablePdfWorkerOptions opts)
    {
